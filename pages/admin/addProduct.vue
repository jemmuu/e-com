  ...
  <v-app>
    ...
    <v-row dense justify="center">
      <v-col md="5" class="mt-2">
        ...
        <!-- alert to  indicate img can not be uploaded without product name -->
        <v-alert
          dense
          outlined
          type="error"
      ...
      <v-col md="5">
        ...
        <v-form ref="form" class="mx-5 mb-3" @submit.prevent="addProduct">
          ...
          <v-text-field
            ...
            placeholder="MD123"
            hint="should be unique for all products"
            required
          ></v-text-field>
...
export default {
  data() {
    ...
    return {
      ...
      show: false, // FIXME: possiblity unused variable
      isUploadingImage: false, // indication of img uploading
      nameAlert: false, // alert trigger
  ...
  methods: {
    // trigger hidden input file for selecting img
    launchImageFile() {
    ...
    // function binded with hidden file input to upload img on fb storage
    // FIXME: if internet connection losses while pic uploading button stays disabled
